class MapService {
    constructor() {
        ...
        // Set global timeout for loading (15 seconds)
        setTimeout(() => {
    ...
    checkLoadingComplete() {
        ...
        if (this.isMapLoaded && this.isDataLoaded && this.isInitialized) {
            ...
            // Double check if overlay should be visible
    ...
    async initializeMap() {
        try {
            ...
            if (this.initRetryCount < this.maxRetries) {
                ...
                console.error('Map failed to initialize after max retries');
                this.isMapLoaded = true;
                this.isInitialized = true;
                this.isDataLoaded = true;
                this.checkLoadingComplete();
    ...
    async loadIncidentsFromFirebase(retryCount = 0) {
        ...
        try {
            ...
            // First quick check if data exists
